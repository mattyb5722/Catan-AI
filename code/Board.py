...
class Board:
    ...
    def PlaceTiles(self):
        ...
        resources = ["ore", "ore", "ore", "wheat", "wheat", "wheat", "wheat", "sheep", "sheep",
            "sheep", "sheep", "brick", "brick", "brick", "wood", "wood", "wood", "wood"]
...
###
    ...
    def PrintTile(self, index):
        index[0] += 1

        temp = self.tiles[index[0]-1].value
    ...
    def PrintBoard(self):
        ...
        print("        {}   {}  {}   {}  {}   {}  {}     ".format(self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), ))
        ...
        print("    {}   {}  {}   {}  {}   {}  {}   {}  {}  ".format(self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), ))
        ...
        print("{}   {}  {}   {}  {}   {}  {}   {}  {}   {}  {}".format(self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), self.PrintTile(y), self.PrintEdge(x), ))
